...
*Допустимо использование любых proxy-сервисов для доступа к OpenAI API. Например, ProxyApi.ru. Для этого потребуется в файле main.go изменить URL, а в качестве API-KEY использовать ProxyAPI key, генерируемый в личном кабинете.*
